...
func TestSelectCargoPrereleaseWithXInIdentifier(t *testing.T) {
	...
	unexpectedOk := !ok || version != "1.9.0-rcx.2"
	if unexpectedOk {
...
func cargoTestVersions() []crateVersionInfo {
	return []crateVersionInfo{
		{Num: "2.0.0"},
		{Num: "1.8.0"},
...
func cargoRequirementCases() map[string]string {
